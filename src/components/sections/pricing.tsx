...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      "Organic reel and localized product page",
      "Tracking and country verification",
      "Full-funnel peer benchmark",
      "GO / NOT YET / NO-GO verdict",
      "Three entry routes and re-test plan",
    ],
    note: "No advertising budget. We track verified market visits from the reel to completed orders.",
    cta: "Run a probe",
    ctaAction: "workspace" as const,
    featured: true,
  },
